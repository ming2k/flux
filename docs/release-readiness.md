...
**Definition:** Every public API declared in `include/flux/flux.h` and
`include/flux/flux_wayland.h` must be implemented and reachable.
...
| Module | Functions | Implemented | Tested | Documented in api.md |
|--------|-----------|-------------|--------|----------------------|
| Context | 3 | 3 | 1 | 1 |
| Surface | 7 | 7 | 2 | 2 |
| Canvas | 2 | 2 | 2 | 0 |
...
| Font / Text | 8 | 8 | 5 | 3 |
| Drawing | 5 | 5 | 3 | 3 |
| Matrix helpers | 3 | 3 | 3 | 0 |
| Inline helpers | 2 | 2 | 2 | 2 |

**How to update:** Run `scripts/check-release-readiness.py --api-matrix` after
...
- Phase 2 (Text) is shipped.
- Unit suite: 10 tests, all green.
- Integration suite: 1 test (`test_offscreen`), green.
- Golden suite: not yet implemented.
- Documentation: `api.md` covers ~50 % of public API.
- No CI.

**Verdict:** flux is at **Alpha → Beta** boundary. It is usable for early
adopters who read the headers and source, but not yet ready for a stable
release tag.
