...
Architecture Decision Records are append-only records of significant design decisions. Once accepted, only update an ADR's status to mark it superseded; write a new ADR for changed decisions.
