...
Lookup-oriented documentation for APIs, build options, and constants.
...
- [Glossary](glossary.md) — Definitions of terms used across the documentation.

## Looking for something else?

- Need task steps? See [How-to guides](../how-to/)
- Want design context? See [Explanation](../explanation/)
- Modifying the codebase? See [Developer docs](../dev/)
